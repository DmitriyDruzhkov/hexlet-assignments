...
class AppTest {
    ...
    public void reverse() {
        ...
        Assertions.assertEquals(text.toString(), "fedcba");
    }

    @Test
    public void checkCharAt() {
        CharSequence text = new ReversedSequence("abcdef");
        Assertions.assertEquals(text.charAt(1), 'e');
    }

    @Test
    public void checkLength() {
        CharSequence text = new ReversedSequence("abcdef");
        Assertions.assertEquals(text.length(), 6);
    }

    @Test
    public void checkSubSequence() {
        CharSequence text = new ReversedSequence("abcdef");
        Assertions.assertEquals(text.subSequence(1,4), "cde");
    }
    // END
}
